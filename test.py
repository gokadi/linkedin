...
# p = {'http': 'http://36.67.77.131:65301', 'https': 'http://36.67.77.131:65301'}
#
...
# h = client.get('https://www.linkedin.com/in/coya-yang-01842b141/', verify=False).content
# print(h)
#
# # from scraper import LinkedInPeopleSpider as linked
# #
# #
# # s = linked('gokadi7@yandex.ru', 'sea1235813')
# # s.init_request()
